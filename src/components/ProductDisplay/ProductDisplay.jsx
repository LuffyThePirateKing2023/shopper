...
import star_ducll_icon from '../Assets/star_dull_icon.png';
    ...
    <div className='productdisplay'>
        ...
        <div className="productdisplay-right">
            ...
            <div className="productdisplay-right-description">
                A ligthweight, usually knitted shirt, close-fitting and a round neckline and
